...
function Program({ programs }: { programs: Array<Program> }) {
      ...
      <div className="program">
        ...
        <div className="information">
          ...
          <div className="flex-row">
            <div className="flex-column" style={{ width: '3.5em', textAlign: 'center' }}>
            ...
            <div className="flex-column" style={{ width: '20.85em' }}>
              ...
              <LED style={{ width: '20.5em', height: '100%' }} text={programs[0].info} />
            </div>
          </div>
        </div>
      </div>
